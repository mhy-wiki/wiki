...
class Weapon extends Base {
  ...
  get gacha() {
    let iPath = `${this.isGs ? "meta-gs" : "meta-sr"}/weapon/${this.type}/${this.name}/${this.isGs ? "gacha" : "icon"}.webp`
    if (fs.existsSync(`${wikiPath.getDir("wiki", true)}/${iPath}`)) return `../../wiki/resources/${iPath}`
    return iPath
  }
  ...
  getDetail() {
    ...
    const path = `resources/meta-${this.isGs ? "gs" : "sr"}/weapon/${this.type}/${this.name}/data.json`
    try {
