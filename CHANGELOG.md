...
* 星铁天赋技能显示能量恢复量与削韧值(将逐步接管全角色)，80级基础数据增加能量上限与满行迹加成
* 增加星铁2.4相关数据
  * 增加星铁2.3.51光锥数据(那无数个春天，落日时起舞)
  * 增加星铁2.3.51角色数据(椒丘，云璃，三月七)

# 1.2.0~1.2.2

* 增加原神4.8相关数据
  * 增加原神4.7.50~4.7.52相关武器buff计算 **@liangshi**
  * 增加原神4.7.50~4.7.52武器数据(柔灯挽歌)
  * 增加原神4.7.50~4.7.52角色数据(艾梅莉埃)
