...
* 增加星铁2.7相关数据
  * 增加星铁2.6.51角色数据(忘归人，星期日)
  * 增加星铁2.6.51光锥数据(长路终有归途，回到大地的飞行)
* 更新原神5.2星铁2.6相关数据
  * 更新原神5.1.52角色数据(恰斯卡，欧洛伦)
  * 更新原神5.1.52武器数据(星鹫赤羽)
  * 增加星铁2.6遗器数据(重循苦旅的司铎，识海迷坠的学者)及buff计算
  * 增加星铁2.6角色数据(乱破)
  
# 1.5.0~1.5.1

* 增加原神5.2相关数据
  * 增加原神5.1.50~5.1.51角色数据(恰斯卡，欧洛伦)
  * 增加原神5.1.50~5.1.51武器数据(星鹫赤羽)及buff计算
